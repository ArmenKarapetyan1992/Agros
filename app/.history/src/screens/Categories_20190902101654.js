            ...
            <View style={styles.container}>
                <View style={styles.searchBarBlock}>
                    <View style={styles.searchBar}>
                        ...
                        <TextInput style={styles.searchInput} placeholder={Strings.Search} placeholderTextColor={Colors.darkGrey} onPress={()=> this.setState({changeStyle : !this.state.changeStyle}) } />
                    </View>
                    <TouchableOpacity style={styles.viewList} >
                        <Icon name={this.state.changeStyle ? "th-large" : "th-list"} size={FontSize.biggestFontSize} color={Colors.green}  />
                    </TouchableOpacity>
                </View>
