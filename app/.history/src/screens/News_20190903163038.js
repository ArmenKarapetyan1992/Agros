                        ...
                        <View style={styles.NewsBlock} >
                            ...
                            <View style={styles.NewsBlockSize}>
                                ...
                                <TouchableOpacity onPress={() => this.changeText()}>
                                    <Text style={ this.state.readMoreText ? styles.ReadMore : styles.ReadMore2 }> {Strings.Readmore} </Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                        <View style={styles.NewsBlock}>
                            ...
                            <View style={styles.NewsBlockSize}>
                                ...
                                <TouchableOpacity onPress={() => this.changeText2()}>
                                    <Text style={ this.state.readMoreText2 ? styles.ReadMore : styles.ReadMore2 }> {Strings.Readmore} </Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                    </View>
