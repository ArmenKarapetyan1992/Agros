                    ...
                    <View style={styles.containerSize}>
                        ...
                        <View style={styles.block3}>
                            ...
                            <View style={styles.block3Box}>
                                ...
                                <Image source={require('../assets/facebook.png')}  style={styles.} />
                                <Image source={require('../assets/twitter.png')} style={styles.}  />
                                <Image source={require('../assets/linkedin.png')} style={styles.}  />
                                <Image source={require('../assets/google.png')}  style={styles.} />
                                </View>
                            </View>
                        </View>
