            ...
            <View style={styles.container}>
                <View style={styles.searchBarBlock}>
                    <View style={styles.searchBar}>
                        ...
                        <TextInput style={styles.searchInput} placeholder={Strings.Search} placeholderTextColor={Colors.darkGrey} on={()=> this.setState({changeStyle : !this.state.changeStyle}) } />
                    </View>
