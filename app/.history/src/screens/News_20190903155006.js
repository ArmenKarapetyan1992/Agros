                    ...
                    <View style={styles.containerSize}>
                        <View style={styles.NewsBlock}>
                            ...
                            <View style={styles.NewsBlockSize}>
                                ...
                                <Text>
                                Rogelio, brother of Minister César Cocarico, was denounced in 2017 for requesting money from a Mennonite colony. For this accusation he was arrested in the prison of Palmasola. The Fourth Court of Judgment of Santa Cruz ordered cessation
                                 of pretrial detention and granted house arrest, plus a 30,000 Bolivian bond for Rogelio Cocarico, one of the Read more
                                </Text>
                            </View>
                        </View>
                    </View>
