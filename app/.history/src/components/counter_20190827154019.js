        ...
        return (
            <Router hideNavBar="true" navigationBarStyle={styles.navBar}>
                <Scene key="root">
                    ...
                    <Scene key="HomeMain" tabs="true" hideNavBar="false" initial={true} icon={<Icon name='exclamation-circle' />}>
                        <Tabs key="Home" component={Home}  />
                        <Tabs key="Categories" component={Categories}  />
