            ...
            <Router hideNavBar="true" navigationBarStyle={styles.navBar}>
                <Scene key="root">
                    ...
                    >
                        ...
                        />
                        <Ta key="Categories" component={Categories} icon={() => this.renderIcon('th')} initial={true} />
                        <Ta key="Add" component={AddProduct} icon={() => this.renderIcon('plus-circle')} />
                        <Ta key="News" component={News} icon={() => this.renderIcon('globe')} />
                        <Ta key="More" component={MorePage} icon={() => this.renderIcon('ellipsis-h')} />
                    </Scene>
