...
import Wonsss from "../screens/Wonsss";
            ...
            <Router hideNavBar="true" navigationBarStyle={styles.navBar}>
                <Scene key="root">
                    ...
                    >
                        ...
                        />
                        <Tabs key="Categories" component={Categories} icon={() => this.renderIcon('th')} initial={true}></Tabs>
                        <Tabs key="Add" component={AddProduct} icon={() => this.renderIcon('plus-circle')} />
                        <Tabs key="News" component={News} icon={() => this.renderIcon('globe')} />
                        <Tabs key="More" component={MorePage} icon={() => this.renderIcon('ellipsis-h')} />
                    </Scene>
