        ...
        return (
            <Router hideNavBar="true" navigationBarStyle={styles.navBar}>
                <Scene key="root">
                    ...
                    >
                        <Scene key="Home" component={Home} icon={() => this.renderIcon('home')} hideNavBar="true" title="Back"

                        />
                        <Scene key="Category" icon={() => this.renderIcon('th')}  title="Back" >
                            <Scene key="Categories" component={Categories} title="back" />
                            <Scene key="Product" component={Product} title="back" />
                            <Scene key="ProductDescription" component={ProductDescription} title="Back" />
                        </Scene>
