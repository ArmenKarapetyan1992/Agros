            ...
            <Router hideNavBar="true" navigationBarStyle={styles.navBar}>
                <Scene key="root">
                    ...
                    >
                        ...
                        />
                        <Scene key="Category" initial={true} icon={() => this.renderIcon('th')} >
                            <Scene key="Categories" component={Categories} />
                            <Scene key="Product" component={Product} hideNavBar="false" />
                            <Scene key="ProductDescription" component={ProductDescription} title="Back"  hideNavBar="true" />
                        </Scene>
