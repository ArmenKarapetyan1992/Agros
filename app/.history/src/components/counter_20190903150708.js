...
class Counter extends Component {
    ...
    render() {
        ...
        return (
            <Router hideNavBar="false" navigationBarStyle={styles.navBar}>
                <Scene key="root">
                    ...
                    >
                        ...
                        />
                        <Scene key="Category" icon={() => this.renderIcon('th')}  >
                            <Scene key="Categories" component={Categories}  />
                            <Scene key="Product" component={Product} navigationBarStyle={styles.navBarCat} />
                            <Scene key="ProductDescription" component={ProductDescription} navigationBarStyle={styles.navBarCat} />
                        </Scene>
                        <Scene key="Add" component={AddProduct} icon={() => this.renderIcon('plus-circle')} />
                        <Scene key="News" component={News} icon={() => this.renderIcon('globe')} initial={true} />
