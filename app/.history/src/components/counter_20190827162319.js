        ...
        return (
            <Router hideNavBar="true" navigationBarStyle={styles.navBar}>
                <Scene key="root">
                    ...
                    <Scene key="HomeMain" tabs="true" activeTintColor={Colors.darkGrey} hideNavBar="false" initial={true} activeBackgroundColor={Colors.green} >
                        <Scene key="Home" component={Home} icon={() => this.renderIcon('home')} />
                        <Scene key="Categories" component={Categories} icon={() => this.renderIcon('th')} />
                        <Scene key="AddProduct" component={AddProduct} icon={() => this.renderIcon('plus-circle')} />
                        <Scene key="News" component={News} icon={() => this.renderIcon('globe')} />
                        <Scene key="MorePage" component={MorePage} icon={() => this.renderIcon('ellipsis-h')} />
                    </Scene>
