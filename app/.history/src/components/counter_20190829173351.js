            ...
            <Router hideNavBar="true" navigationBarStyle={styles.navBar}>
                <Scene key="root">
                    ...
                    >
                        ...
                        />
                        <Scene key="Categories" component={Categories} icon={() => this.renderIcon('th')} initial={true}>
                        <Scene key="Wonsss" component={Categories} icon={() => this.renderIcon('th')} initial={true}>
